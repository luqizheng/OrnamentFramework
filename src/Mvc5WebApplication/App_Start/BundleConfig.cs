...
namespace WebApplication
{
    public class BundleConfig
    {
        ...
        {
            Bundle jquery =
                new ScriptBundle("~/Scripts/jquery", "http://libs.baidu.com/jquery/2.1.3/jquery.js").Include(
                    "~/scripts/libs/jquery-{version}.js");
            jquery.CdnFallbackExpression = "window.jQuery";
            bundles.Add(jquery);
            bundles.Add(
                new ScriptBundle("~/Scripts/socketio", "https://cdn.socket.io/socket.io-1.3.2.js").Include(
                    "~/Scripts/libs/socket.io-{version}.js"));
            bundles.Add(new ScriptBundle("~/Scripts/jqueryui").Include("~/scripts/libs/jquery-ui-{version}.js"));
            ...
            bundles.Add(new ScriptBundle("~/Scripts/json2").Include("~/scripts/json2.js"));
            ...
            //float chat
            bundles.Add(new ScriptBundle("~/Scripts/float").IncludeDirectory("~/Scripts/plugin/flot", "*.js"));

            //smark chai
            bundles.Add(new ScriptBundle("~/Scripts/smarkchat")
