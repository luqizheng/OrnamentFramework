...
namespace Ornament.MemberShip.Plugin.Models.Memberships
{
    public class ChangePasswordModel
    {
        ...
        [Display(Name = "CurrentPassword", ResourceType = typeof (Ornament.MemberShip.Properties.Resources))]
        [DataType(DataType.Password)]
        public string CurrentPassword { get; set; }

        [Display(Name = "NewPassword", ResourceType = typeof(Ornament.MemberShip.Properties.Resources))]
        ...
        [Display(Name = "ConfirmPassword", ResourceType = typeof(Ornament.MemberShip.Properties.Resources))]
        [DataType(DataType.Password)]
