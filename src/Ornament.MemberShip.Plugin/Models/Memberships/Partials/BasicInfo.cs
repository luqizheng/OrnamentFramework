...
namespace Ornament.MemberShip.Plugin.Models.Memberships.Partials
{
    public class BasicInfo
    {
        ...
        [Required(ErrorMessageResourceName = "error_MissLoginId", ErrorMessageResourceType = typeof(Properties.Resources))]
        ...
        [Remote("NotDuplicateEmail", "User", "MemberShips", AdditionalFields = "Id",
            ErrorMessageResourceType = typeof(Properties.Resources), ErrorMessageResourceName = "alertMsg_duplicate_Email")]
