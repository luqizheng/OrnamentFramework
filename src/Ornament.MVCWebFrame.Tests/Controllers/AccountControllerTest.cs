...
namespace Ornament.MVCWebFrame.Tests.Controllers
{
    ...
    public class AccountControllerTest
    {
        ...
        public void ChangePasswordPostReturnsViewIfNewPasswordIsNull()
        {
            ...
            // Act
            var jsonResult = (JsonResult)controller.ChangePassword("currentPassword", null, null);
            var result = jsonResult.Data as ReturnResult;
        ...
        public void ConstructorSetsProperties()
        {
            ...
            // Act
            var controller = new AccountController(formsAuth, membershipService);
        ...
        public void RegisterPostRedirectsHomeIfRegistrationSuccessful()
        {
            ...
            // Act
            var result = (RedirectToRouteResult)controller.Register("someUser", "email", "goodPass", "goodPass");
        ...
        public void RegisterPostReturnsViewIfEmailNotSpecified()
        {
            ...
            // Act
            var result = (ViewResult)controller.Register("username", "", "password", "password");
        ...
        public void RegisterPostReturnsViewIfNewPasswordDoesNotMatchConfirmPassword()
        {
            ...
            // Act
            var result = (ViewResult)controller.Register("username", "email", "password", "password2");
        ...
        public void RegisterPostReturnsViewIfPasswordIsNull()
        {
            ...
            // Act
            var result = (ViewResult)controller.Register("username", "email", null, null);
        ...
        public void RegisterPostReturnsViewIfPasswordIsTooShort()
        {
            ...
            // Act
            var result = (ViewResult)controller.Register("username", "email", "12345", "12345");
        ...
        public void RegisterPostReturnsViewIfRegistrationFails()
        {
            ...
            // Act
            var result =
                (ViewResult)controller.Register("someUser", "DuplicateUserName" /* error */, "badPass", "badPass");
        ...
        public void RegisterPostReturnsViewIfUsernameNotSpecified()
        {
            ...
            // Act
            var result = (ViewResult)controller.Register("", "email", "password", "password");

            // Assert
            Assert.AreEqual(6, result.ViewData["PasswordLength"]);
            Assert.AreEqual("请填写用户名.",
                            result.ViewData.ModelState["username"].Errors[0].ErrorMessage);
        }
        ...
        #region Nested type: MockIdentity
        ...
        #region Nested type: MockMembershipProvider
        ...
        #region Nested type: MockMembershipUser
        ...
        #region Nested type: MockPrincipal
