...
namespace Ornament.Domain.Test
{
    ...
    public class TimeTest
    {
        ...
        {
            var target = new Time(0,23,0); // TODO: Initialize to an appropriate value
            int actual;
        ...
        {
            var target = new Time(1,2,3,4); // TODO: Initialize to an appropriate value
            int actual;
        ...
        {
            var a = new Time(); // TODO: Initialize to an appropriate value
            var b = new Time(); // TODO: Initialize to an appropriate value
