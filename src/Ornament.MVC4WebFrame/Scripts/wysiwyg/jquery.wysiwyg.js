...
(function ($) {
    ...
    function Wysiwyg() {
        ...
        this.defaults = {
            ...
            toolbarHtml: '<div role="menu" class="btn-toolbar"><div class="btn-group"></div></div>',
        ...
        this.ui.appendItem = function (name, control) {
            ...
            $('<a class="btn btn-mini"></a>')
                .append(icon ? '<i class="' + icon + '"></i>' : '<span>' + className + '</span>')
                .addClass(className)
				.attr("title", tooltip)
				...
				.appendTo($("div:last-child",self.ui.toolbar));
        };
        this.ui.appendItemCustom = function (name, control) {
            ...
            return $('<a role="menuitem" unselectable="on"><a>')
                .append(icon ? '<i class="' + icon + '"></i>' : '<span>' + name + '</span>')
				...
				.appendTo($("div.btn-group:last-child",$(self.ui.toolbar)));
               
        };

        this.ui.appendItemSeparator = function () {
            var self = this.self;
            return $('<div  role="separator" class="btn-group"></div>').appendTo(self.ui.toolbar);
        };
    ...
    $(function () { // need access to jQuery UI stuff.
        ...
        $.wysiwyg.dialog.register("default", function () {
            ...
            this.init = function () {
                ...
                that._$dialog = $('<div class="modal hide"></div>').css({ "z-index": this.options.zIndex });
                var $topbar = $('<div class="modal-header"><button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button><h5>' + this.options.title + '</h5></div>');
                var $dcontent = $('<div class="modal-body">' + content + '</div>');
                var $footer = $('<div class="modal-footer">' + footer + "</div>");

                that._$dialog.append($topbar).append($dcontent).append($footer).modal(); //start boostrap
