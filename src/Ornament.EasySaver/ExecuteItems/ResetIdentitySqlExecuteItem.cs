...
{
    public class ResetIdentitySqlExecuteItem : GenericSqlExecuteItem<ResetIdentitySqlExecuteItem>
    {
        public ResetIdentitySqlExecuteItem(DataHelper helper, string tableName, int resetNumber)
        ...
        protected internal override void RunSql(IDriver executer)
        {
